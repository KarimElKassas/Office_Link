...
class SelectDirectionComponent extends StatelessWidget {
  SelectDirectionComponent({Key? key}) : super(key: key);
          ...
          builder: (context, state){
            ...
            return DropdownButtonHideUnderline(
              child: DropdownButton2<DirectionModel>(
                isExpanded: true,
                hint: Text(
                  cubit.selectedDirection == null ? AppStrings.selectDirection.tr() : cubit.selectedDirection!.directionName,
                  style: TextStyle(
                ...
                items: cubit.directionsList
                  ...
                  child: Text(
                    ...
                    .toList(),
                value: cubit.selectedDirection,
                onChanged: (value) {
                  cubit.changeSelectedDirection(value!);
                },
