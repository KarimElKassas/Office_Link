...
class GetSectorsComponent extends StatelessWidget {
  GetSectorsComponent({Key? key,}) : super(key: key);
      ...
      builder: (context, state){
        ...
        return DropdownButtonHideUnderline(
          child: DropdownButton2<SectorModel>(
            isExpanded: true,
            hint: Text(
              cubit.selectedSectorModel == null ? AppStrings.selectSector.tr() : cubit.selectedSectorModel!.sectorName,
              style: TextStyle(
            ...
            items: cubit.sectorsList
              ...
              child: Text(
                ...
                .toList(),
            value: cubit.selectedSectorModel,
            onChanged: (value) {
              cubit.changeSelectedSector(value!);
            },
