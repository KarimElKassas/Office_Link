        ...
        return BlocConsumer<NewLetterCubit, NewLetterStates>(
          ...
          builder: (context, state){
            return DropdownButtonHideUnderline(
              child: DropdownButton2<Map<int,String>>(
                isExpanded: true,
                hint: Text(
                  cubit.selectedLetterType == null ? AppStrings.selectType.tr() : cubit.selectedLetterType!.values.first,
                  style: TextStyle(
                ...
                items: cubit.typesList
                  ...
                  child: Text(
                    ...
                    .toList(),
                value: cubit.selectedLetterType,
                onChanged: (value) {
                  cubit.changeSelectedLetterType(value!);
                },
                ...
                dropdownSearchData: DropdownSearchData(
                  ...
                  searchInnerWidget: Container(
                    ...
                    child: registerTextField(
                        ...
                        hintText: AppStrings.searchForType.tr(),
