...
import 'package:foe_archiving/presentation/features/archived_letters/incoming/ui/archived_income_letters_list.dart';
...
import '../bloc/incoming_archived_letters_states.dart';

class IncomingArchivedLettersScreen extends StatelessWidget {
  const IncomingArchivedLettersScreen({super.key});
...
Widget searchAndFilterWidget(BuildContext context, IncomingArchivedLettersCubit cubit){
  return Container(
