...
class ArchivedOutgoingLettersListView extends StatelessWidget {
  final OutgoingArchivedLettersCubit letterCubit; // Pass your LetterCubit instance

  const ArchivedOutgoingLettersListView({
    Key? key,
  ...
  Widget headerItem(BuildContext context, OutgoingArchivedLettersCubit cubit){
    return Padding(
  ...
  Widget _buildListView(BuildContext context, OutgoingArchivedLettersStates state) {
    return Column(
      children: [
          ...
          child: ScrollbarTheme(
            ...
            child: Scrollbar(
              ...
              child: ListView.builder(
                ...
                shrinkWrap: true,
                key: key,
                itemCount: getListToUse(letterCubit, state).length + (state is OutgoingArchivedLettersLoading ? 1 : 0),
                itemBuilder: (context, index) {
                  ...
                  } else if (state is OutgoingArchivedLettersLoading){
                    return Padding(
      ...
      child: Material(
        ...
        child: Container(
          ...
          Navigator.pushNamed(
              ...
              arguments: LetterDetailsArgs(letterModel,false,outgoingArchivedLettersCubit: letterCubit));
...
List<LetterModel> getListToUse(OutgoingArchivedLettersCubit cubit, OutgoingArchivedLettersStates state) {
