...
class OutgoingExternalLettersListView extends StatelessWidget {
  final OutgoingExternalLettersCubit letterCubit; // Pass your LetterCubit instance

  const OutgoingExternalLettersListView({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<OutgoingExternalLettersCubit, OutgoingExternalLettersStates>(
      bloc: letterCubit,
        ...
        child: Container(
          ...
          child: Row(
            ...
            Expanded(
              ...
              Expanded(
                child: Text(
                  AppStrings.receiverDirection.tr(),
                  style: TextStyle(
                      color: Theme.of(context).primaryColorDark,
                      fontFamily: FontConstants.family,
                      fontSize: AppSize.s16,
  ...
  Widget _buildListView(BuildContext context, OutgoingExternalLettersStates state) {
    return Column(
      children: [
          ...
          child: ScrollbarTheme(
            ...
            child: Scrollbar(
              ...
              child: ListView.builder(
                ...
                shrinkWrap: true,
                key: key,
                itemCount: getListToUse(letterCubit, state).length + (state is OutgoingExternalLettersLoading ? 1 : 0),
                itemBuilder: (context, index) {
                  ...
                  } else if (state is OutgoingExternalLettersLoading){
                    return Padding(
...
List<LetterModel> getListToUse(OutgoingExternalLettersCubit cubit, OutgoingExternalLettersStates state) {
