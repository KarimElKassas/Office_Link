...
import '../bloc/external_letter_details_cubit.dart';
import '../bloc/external_letter_details_states.dart';

class ExternalLetterDetailsScreen extends StatelessWidget {
  ExternalLetterDetailsScreen({super.key, required this.letterModel,required this.fromReplyScreen});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<ExternalLetterDetailsCubit>()..getLetter(Guid(letterModel.externalLetterId.toString())),
      child: BlocConsumer<ExternalLetterDetailsCubit, ExternalLetterDetailsStates>(
        listener: (context, state) {
          if(state is ExternalLetterDetailsSuccessfulDeleteLetter){
            Navigator.pop(context);
            Navigator.pop(context);
          }
          if(state is ExternalLetterDetailsErrorDeleteLetter){
            Navigator.pop(context);
        ...
        builder: (context, state) {
          var cubit = ExternalLetterDetailsCubit.get(context);
                            ...
                            Expanded(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      cubit.letterModel!.isIncoming! == true ? AppStrings.senderDirection.tr() : AppStrings.receiverDirection.tr(),
                                      style: TextStyle(
                                          color: ColorManager.goldColor,
                                          fontSize: AppSize.s18,
                                          fontFamily: FontConstants.family,
...
Widget seenWidget(BuildContext context, ExternalLetterDetailsCubit cubit){
  return Container(
    decoration: BoxDecoration(
        color: Theme.of(context).splashColor,
        borderRadius: BorderRadius.circular(AppSize.s8)),
...
Widget unSeenWidget(BuildContext context, ExternalLetterDetailsCubit cubit){
  return Container(
    decoration: BoxDecoration(
        color: Theme.of(context).splashColor,
        borderRadius: BorderRadius.circular(AppSize.s8)),
...
Widget seenItem(BuildContext context, ExternalLetterDetailsCubit cubit, int index){
  return Container(
    padding: const EdgeInsets.symmetric(horizontal: AppSize.s8,vertical: AppSize.s6),
...
Widget unSeenItem(BuildContext context, ExternalLetterDetailsCubit cubit, int index){
  return Container(
    padding: const EdgeInsets.symmetric(horizontal: AppSize.s8,vertical: AppSize.s6),
    margin: const EdgeInsets.symmetric(vertical: AppSize.s6),
    decoration: BoxDecoration(
...
Widget alterDeleteDialog(BuildContext context, ExternalLetterDetailsCubit cubit) {
...
Widget selectedKnowDepartmentsWidget(BuildContext context, ExternalLetterDetailsCubit cubit) {
  return Container(
    width: 350,
    decoration: BoxDecoration(
...
Widget selectedActionDepartmentsWidget(BuildContext context, ExternalLetterDetailsCubit cubit) {
  return Container(
    width: 350,
    decoration: BoxDecoration(
      borderRadius: BorderRadius.circular(AppSize.s6),
    ...
    child: AlertDialog(
      // <-- SEE HERE
        ...
        content: SizedBox(
            ...
            child: ExternalLetterDetailsScreen(
