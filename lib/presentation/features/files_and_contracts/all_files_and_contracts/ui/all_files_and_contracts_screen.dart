...
import 'package:foe_archiving/presentation/features/files_and_contracts/all_files_and_contracts/ui/all_files_and_contracts_list.dart';
...
class AllFilesAndContractsScreen extends StatelessWidget {
  const AllFilesAndContractsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<AllFilesAndContractsCubit>()..setupScrollController(context)..loadContracts(),
      child: BlocConsumer<AllFilesAndContractsCubit,AllFilesAndContractsStates>(
        listener: (context, state){},
        builder: (context, state){
          var cubit = AllFilesAndContractsCubit.get(context);
          var commonDataCubit = sl<CommonDataCubit>();

          return Scaffold(
            appBar: AppBar(
              centerTitle: true,
              title: Text(AppStrings.filesAndContracts.tr(),
            ...
            body: FadeIn(
                ...
                child: Column(
                  children: [
                    ...
                    Expanded(
                      child: AllFilesAndContractsListView(contractsCubit: cubit,),
                    ),
                  ],
                ),
            ),
...
Widget searchAndFilterWidget(BuildContext context, AllFilesAndContractsCubit cubit){
  return Container(
