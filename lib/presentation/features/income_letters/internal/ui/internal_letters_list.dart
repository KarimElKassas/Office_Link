...
class DefaultLettersListView extends StatelessWidget {
  final IncomeInternalLettersCubit letterCubit; // Pass your LetterCubit instance

  const DefaultLettersListView({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<IncomeInternalLettersCubit, IncomeInternalLettersStates>(
      bloc: letterCubit,
  ...
  Widget _buildListView(BuildContext context, IncomeInternalLettersStates state) {
    return Column(
      children: [
          ...
          child: ScrollbarTheme(
            ...
            child: Scrollbar(
              ...
              child: ListView.builder(
                ...
                shrinkWrap: true,
                key: key,
                itemCount: getListToUse(letterCubit, state).length + (state is IncomeInternalLettersLoading ? 1 : 0),
                itemBuilder: (context, index) {
                  ...
                  } else if (state is IncomeInternalLettersLoading){
                    return Padding(
...
List<LetterModel> getListToUse(IncomeInternalLettersCubit cubit, IncomeInternalLettersStates state) {
