...
import '../bloc/income_external_letters_cubit.dart';
import '../bloc/income_external_letters_states.dart';

class IncomeExternalLettersScreen extends StatelessWidget {
  const IncomeExternalLettersScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => sl<IncomeExternalLettersCubit>()..setupScrollController(context)..loadDefaultLetters(),
      child: BlocConsumer<IncomeExternalLettersCubit,IncomeExternalLettersStates>(
        listener: (context, state){},
        builder: (context, state){
          var cubit = IncomeExternalLettersCubit.get(context);
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height:  AppSize.s16,),
                   Expanded(
                    child: ExternalLettersListView(letterCubit: cubit,),
                  ),
                ],
              )
            ),
...
Widget searchAndFilterWidget(BuildContext context, IncomeExternalLettersCubit cubit){
  return Container(
