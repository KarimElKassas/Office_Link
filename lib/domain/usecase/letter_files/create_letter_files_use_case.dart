...
class CreateLetterFileUseCase extends BaseUseCase<String, TokenAndDataParameters> {
  BaseLetterRepository letterRepository;
  CreateLetterFileUseCase(this.letterRepository);

  @override
  Future<Either<Failure, String>> call(TokenAndDataParameters parameters)async {
    return await letterRepository.createLetterFiles(parameters);
  }
}
